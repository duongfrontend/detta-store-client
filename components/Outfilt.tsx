...
const Outfilt = () => {
  return (
    <div className="w-full max-[664px]:gap-10 max-[664px]:flex-col max-[664px]:flex">
      <div className="flex justify-center items-center bg-[#eae9e7] max-[664px]:flex-col max-[664px]:gap-10">
      ...
      <div className="flex justify-center items-center bg-[#eae9e7] max-[664px]:flex-col-reverse max-[664px]:gap-10">
        <div className="h-full flex-1 max-[664px]:w-full">
